...
for arm in range(num_arms):
    ...
    theta_scatter = theta_arm + np.random.normal(0, (arm_spread / 7) * 1.5, num_stars_arms)  # Increased noise
...
ax.set_title('Rotating 3D Spiral Galaxy - Top View', color='white')
...
try:
    ...
    anim.save('galaxy_rotation_top.mp4', writer=writer)
    print("Animation saved as 'galaxy_rotation_top.mp4'. Play it to see the motion.")
...
try:
    ...
    print("Please check the saved 'galaxy_rotation_top.mp4' file for the animation.")